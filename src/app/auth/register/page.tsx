...
export default function RegisterPage() {
  ...
  }, [fullName, preferredLanguage, email, password, agree, loading, fieldErrors]);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <option value="om">Oromiffa (Afaan Oromo)</option>
            </select>

            {fieldErrors.preferredLanguage && (
              <p className="text-[12px] text-red-700">{fieldErrors.preferredLanguage}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            >
              <input
                ...
                required
                placeholder="••••••••"
                className="flex-1 bg-white text-[#2f1c0d] text-sm font-medium outline-none border-0 focus:ring-0 placeholder:text-[#7a5a3a]/60"
              />
              <button
                type="button"
            ...
            {fieldErrors.password && (
              <p className="text-[12px] text-red-700">{fieldErrors.password}</p>
            )}
          </div>
          ...
          <div className="pt-1">
            <div className="flex items-center gap-2.5">
              ...
              />
              <label htmlFor="agree" className="text-sm font-semibold text-[#3b2411]">
                I agree with the{" "}
                <Link
                  href="#"
          ...
          {error && <p className="text-[13px] text-red-700 pt-1 font-medium">{error}</p>}
...
function LabeledWhiteInput({
  ...
  return (
    <div className="space-y-1.5">
        <label className="block text-base font-semibold text-[#3b2411]">{label}</label>
      <div
      ...
      >
        <input
          ...
          className="w-full bg-white text-[#2f1c0d] text-sm font-medium outline-none border-0 focus:ring-0 placeholder:text-[#7a5a3a]/60"
        />
      </div>
