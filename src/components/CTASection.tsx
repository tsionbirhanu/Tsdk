...
// Brown background CTA matching the screenshot; reusable component
const CTASection = () => (
	<section className="py-24 bg-[#f3e3cf] relative overflow-hidden">
		...
		>
			<h2 className="font-display text-3xl md:text-4xl font-bold text-[#3b2411] mb-6">
				Ready to Give with Purpose?
			</h2>
			<p className="text-[#4b2e18] text-lg mb-8 leading-relaxed">
				Join thousands of believers who are honouring their commitments digitally —
