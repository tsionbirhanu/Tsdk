  ...
  <footer className="bg-[#2b1608] text-[#f3e3cf] py-16">
    <div className="max-w-7xl mx-auto px-6">
      <div className="grid md:grid-cols-4 gap-12 mb-12">
        {/* Brand */}
        <div>
          <h3 className="font-display text-2xl font-bold text-[#f3e3cf] mb-4">
            TSEDQ
          </h3>
          <p className="text-sm leading-relaxed text-[#f3e3cf]/90">
            Digitizing faithful giving for churches and communities — with transparency,
        ...
        {Object.entries(footerLinks).map(([title, links]) => (
          <div key={title}>
            <h4 className="font-body text-sm font-semibold uppercase tracking-wider text-[#ffe599] mb-4">
              {title}
            </h4>
      ...
      <div className="border-t border-[#3b2411]/20 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-[#f3e3cf]/80">
        <p>© 2026 TSEDQ — FaithTech & FinTech Platform. All rights reserved.</p>
      </div>
    </div>
  </footer>
);
